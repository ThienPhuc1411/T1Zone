                                ...
                                <form action="index.php?act=add-Sp" method="post" enctype="multipart/form-data">
                                    <div class="forms-sample">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span style="color:red;font-size: 14px;"><?=(isset($ten_error)? $ten_error:"")?></span><br>
                                        </div>
                                        <div class="form-group">
...
<option value="3">Bàn phím</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span style="color:red;font-size: 14px;"><?=(isset($price_error)? $price_error:"")?></span><br>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <span style="color:red;font-size: 14px;"><?=(isset($price_sale_error)? $price_sale_error:"")?></span><br>
                                        </div>
                                        <div class="form-group">
