    ...
    <div class="main-panel">
      <div class="content-wrapper">
        <div class="page-header">
          <h3 class="page-title">Tất cả thương hiệu</h3>
        </div>
        <div class="row">
                  ...
                  <table id="example" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="tenth">Tên thương hiệu</th>
                        ...
                        <tbody>
                              ...
                              if(isset($kq) && count($kq) > 0){
                                ...
                                foreach ($kq as $th) {
                                  if($th['visible'] == 1){
                                    ...
                                    $change = '<a href="index.php?act=hide-Thuong-Hieu&id='.$th['id'].'" class="btn btn-warning btn-md">Ẩn</a>';
                                  }else{
                                    $hienthi = 'Ẩn';
                                    $change = '<a href="index.php?act=show-Thuong-Hieu&id='.$th['id'].'" class="btn btn-success btn-md">Hiện</a>';
                                  }
                                  ...
                                  echo '<tr>
                                            ...
                                            <td class="stt">'.$i.'</td>
                                            <td class="tendm">
                                                <div class="table-td-content">'.$th['tendm'].'</div>
                                            </td>
                                            <td class="tenth">
                                                <div class="table-td-content">'.$th['tenth'].'</div>
                                            </td>
                                            <td class="logo">
                                                <img src="../Assets/uploads/logo/'.$th['logo'].'" alt="" width = "150">
                                            </td>
                                            <td class="hienthi">'.$hienthi.'</td>                              
                                            <td class="hanhdong">
                                                <div class="table-td-button">
                                                    <div>'.$change.'</div>
                                                    <a href="index.php?act=edit-Thuong-Hieu&id='.$th['id'].'" class="btn btn-primary btn-md">Sửa</a>
                                ...
                                <div class="modal-content animate">
                                  <div class="container" style="background-color:white">
                                      ...
                                      <div style="display:flex;justify-content:center;gap:20px;"> 
                                        ...
                                        <a href="xoa-Thuong-Hieu&id=' . $th['id'] . '" class="btn btn-danger btn-md">Xóa</a>
                            ...
                            <!-- <tr>
                                ...
                                <td class="img">
                                    <img src="https://qph.cf2.quoracdn.net/main-qimg-341b25ecdc005e2cd0084aa8c3e1c816-lq" alt="">
                                </td>
